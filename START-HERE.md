...
**Do not ask the founder to drop files into `C:\Users\delko\ollama-electron`.**
...
| 3 | **KorBek AI** | Load this pack as knowledge. Answer from the map. Propose ERP writes | Claim live Supabase writes. Mix the five products. Send the founder a hunt list or an ollama-electron copy step |
...
## 2. Load order (do this yourself, in the other chat)

1. **`PROJECTS.md`** — which product is which.
2. **`LOCKSTEP.md`** — the contract the three of you share. Frozen rules. Who owns what.
3. **`WHAT-WE-BUILT.md`** — what the ERP workspace already shipped. Do not redo it. Do not contradict it.
4. Your lane:
...
5. Optional: `FILEMAP.md` when you need a file. `erp/` is sanitized source (keys redacted, no photos).
