...
SET
  ...
  raw_user_meta_data = coalesce(raw_user_meta_data, '{}'::jsonb)
    || jsonb_build_object('role', 'Founder', 'designation', 'Founder')
...
SET
  ...
  raw_user_meta_data = coalesce(raw_user_meta_data, '{}'::jsonb)
    || jsonb_build_object('role', 'Systems Developer', 'designation', 'Systems Developer')
...
SET
  ...
  raw_user_meta_data = coalesce(raw_user_meta_data, '{}'::jsonb)
    || jsonb_build_object('role', 'IT Director', 'designation', 'IT Director')
